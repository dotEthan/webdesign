...
//   let websiteCheck = ($('#website--check').is(':checked')) ? 'website' : 'no website';
//   let seoCheck = ($('#seo--check').is(':checked')) ? 'SEO' : 'no SEO';
//   let hostingCheck = ($('#hosting--check').is(':checked')) ? 'Hosting' : 'no Hosting';
